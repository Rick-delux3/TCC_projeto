...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Estas linhas são as mensagens padrão usadas pela classe Validator.
    | Algumas regras possuem várias versões, como regras de tamanho.
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'A senha informada foi encontrada em vazamentos de dados. Por favor, use outra senha.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode definir nomes mais “bonitos” para os atributos.
    | Exemplo: transformar "email" → "E-mail".
    |
    */
