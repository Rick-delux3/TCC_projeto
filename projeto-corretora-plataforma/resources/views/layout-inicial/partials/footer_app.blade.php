 <footer>
        <div class="bio d-flex text-center">
            <h1>
                Nós somos uma Corretora especialista em Seguro de aluguel e soluções imobiliárias. Aqui é simples é online! e rápido!
                Akialuga é marca registrada da Neves Corretora.
            </h1>
        </div>
        ...
        <div class="redes d-flex row">
            ...
            <div class="col-3">
                <p class="text-center">Termos de Uso e Politica de Privaciadade</p>
            </div>
