    ...
    <section class="row g-0 overflow-hidden bg-white border shadow-lg rounded-3 mx-auto" style="max-width: 960px;">
        ...
        >
            <img
                ...
                alt="Instabilidade na plataforma"
            ...
            <div class="position-relative d-flex h-100 flex-column justify-content-end p-4 p-md-5" style="min-height: 420px;">
                ...
                <h2 class="h3 fw-bold mb-3">Estamos ajustando a operação</h2>

                <p class="mb-0 text-white-50">
                    {{ config('branding.active', 'tcc') === 'client'
                        ? 'A '.config('branding.profiles.client.name', 'Aki Aluga')
                        : 'A NVS' }} mantém a experiência segura enquanto uma falha interna
                    impede a conclusão desta solicitação.
                </p>
            </div>
        </aside>
        ...
        <div class="col-lg-7 d-flex flex-column justify-content-center p-4 p-md-5">
            ...
            <div class="alert alert-light border d-flex align-items-start gap-2 py-3" role="alert">
                <span class="badge text-bg-danger flex-shrink-0">Suporte</span>
                <small class="text-secondary">
                    Se o problema continuar, informe o responsável pela plataforma para uma verificação técnica.
                </small>
            </div>
